...
def main(BASE_NAME, LOAD_NAME, REOPT_INPUTS, microgrid, playground_microgrids, GEN_NAME, FULL_NAME, OMD_NAME, ONELINE_NAME, MAP_NAME, REOPT_FOLDER, BIG_OUT_NAME):
	...
	opendss_playground.play('./lehigh.dss.omd', './lehigh_base_phased.dss', None, None, playground_microgrids, '670671', False, 60, 120, 30) #TODO: unify the microgrids data structure.
	microgrid_report_csv('/allOutputData.json', 'microgrid_report.csv', REOPT_FOLDER, microgrid)

...
if __name__ == '__main__':
	...
	main(FULL_NAME_2, LOAD_NAME, REOPT_INPUTS, microgrid_3, playground_microgrids, GEN_NAME, FULL_NAME_3, OMD_NAME, ONELINE_NAME, MAP_NAME, REOPT_FOLDER_3, BIG_OUT_NAME_3, QSTS_STEPS)
	main(FULL_NAME_3, LOAD_NAME, REOPT_INPUTS, microgrid_4, playground_microgrids, GEN_NAME, FULL_NAME_4, OMD_NAME, ONELINE_NAME, MAP_NAME, REOPT_FOLDER_4, BIG_OUT_NAME_4, QSTS_STEPS)

...
def _tests():
	...
	FAULTED_LINE = 670671
	all_dir = ['3mgs_wizard_loadGrouping', '3mgs_wizard_lukes', '3mgs_wizard_branch', '3mgs_wizard_bottomUp', '3mgs_wizard_criticalLoads', '3mgs_lehigh_manual', '3mgs_lehigh_loadGrouping', '3mgs_lehigh_lukes', '3mgs_lehigh_branch', '3mgs_lehigh_bottomUp', '3mgs_lehigh_criticalLoads']
	MG_MINES = {
	...
	for dir in all_dir:
		...
		final_run_count = len(MG_MINES[dir]) - 1 # FULL_NAME is based on the count of the microgrid in the final run.
		print(f'---------------------------------------------------------\nRunning test of microgridup_control.play() on {dir}.\n---------------------------------------------------------')
		play(f'circuit_plusmg_{final_run_count}.dss', f'{_myDir}/{dir}', MG_MINES[dir], FAULTED_LINE)
	return

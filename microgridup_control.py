...
def make_chart_from_csv(csvName, y_list, year, microgrids, chart_name, y_axis_name, outage_start, outage_length, batt_kwh_ratings, fossil_kw_ratings, vsource_kw_ratings={}, rengen_kw_ratings={}, rengen_mgs={}):
	...
	fossil_kwh_output, diesel_dict, natural_gas_dict, fossil_traces, batt_cycles, glc_traces = extract_charting_data(csvName, microgrids, y_list, outage_start, outage_length, fossil_kw_ratings, vsource_kw_ratings, year, rengen_mgs, storage_proportional_loadshapes, batt_kwh_ratings, rengen_proportional_loadshapes)

from microgridup_fossil_over_crit_kw_enabled import *
...
if __name__ == '__main__':
	# Input data.
	MODEL_DIR = '4mgs_with_fossil_over_crit_kw_enabled'
	...
	# Run model.
	full(MODEL_DIR, BASE_DSS, LOAD_CSV, QSTS_STEPS, FOSSIL_BACKUP_PERCENT, REOPT_INPUTS, MICROGRIDS, FAULTED_LINE, FOSSIL_OVER_CRIT_KW, open_results=True, OUTAGE_CSV=OUTAGE_CSV)
...
'''This version of microgridup institutes running REopt/mgDesign to get the 
initial economically optimized generation while connected to the macrogrid,
then the diesel_sizing() function resizes diesel to support the max_net_load
and any additional loadgrowth indicated byt the user. This new diesel along 
with the initial generation specs is rerun by REopt to output both the economic
analysis and resilience results '''
